            ...
            if event.is_action_pressed('jump'):
                ...
                hideLabel($UnoCamera/CanvasLayer/Continue).callback(
                    func():
                        ...
                        .callback(func(): $UnoCamera.fadeOut().callback(func(): get_tree().change_scene_to_packed(load('res://game/scenes/game_tutorial.scn')))))
...
func _process(delta: float) -> void:
    ...
    match state:
        1:
            ...
            .callback(func(): currentText = $UnoCamera/CanvasLayer/Text1.text; $UnoCamera/CanvasLayer/Text1.text = ''; state += 1)
        3:
            if charTimer <= 0:
